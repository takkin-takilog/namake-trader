...
class RosParameterErrorException(Exception):
    """Raised when an exception occurs validating ROS parameter."""

    def __init__(self, *args: object) -> None:
        Exception.__init__(self, "Error occurs validating ROS parameter", *args)
